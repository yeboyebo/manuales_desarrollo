...
- Al igual que las facturas Firmadas, para actualizar el estado de **Pte.anular** a **Anulada**, pulsaremos en el botón de **Comprobar estado** o en la siguiente factura que se envíe a Fískaly se actulaizará.
...
- Todas las facturas que estén creadas antes de la implantación de Fiskaly/Veri*Factu, serán marcadas con el estado **PRE_Verifactu**, este estado permite modificar y borrar las facturas pero no presentarlas.